        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">Perbaharui Sales</div>
                    <form action="{{ route('supplier.update', $supplier->id) }}" class="form-horizontal" method="post" style="margin-top: 20px; margin-bottom: 20px">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group @if ($errors->has('phone_number')) has-error @endif">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="phone_number" name="phone_number" class="form-control" value="{{ $supplier->phone_number }}">
                            </div>
                        </div>
